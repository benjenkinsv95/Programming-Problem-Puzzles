 ...
 */
package q8.largest.product.in.a.series;
...
public class Q8LargestProductInASeries {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < series.length() - numDigits; i++){
            long product = productOfNDigits(numDigits, series, i); 
            highestProduct = Math.max(product, highestProduct);
        }
    ...
    /**
     * Returns the product found by multiplying n digits taken from the series of digits, starting at the beginning
     * index and multiplies all of their values together.
     * @param numDigits
     * @param seriesOfDigits
     * @param beginningIndex
     * @return 
     */
    public static long productOfNDigits(int numDigits, String seriesOfDigits, int beginningIndex){
        long product = 1;
        for(int i = beginningIndex; i < beginningIndex + numDigits; i++){
            product *= seriesOfDigits.charAt(i) - '0';
        }
        return product;
    }
